...
IDENTITY_PREFIX='sysml'

IDENTITY_NOTE = IDENTITY_PREFIX+'.note'
IDENTITY_NOTE_CONN = IDENTITY_PREFIX+'.noteConn'
IDENTITY_TRANSITION = IDENTITY_PREFIX+'.transition'
IDENTITY_INITIAL_STATE = IDENTITY_PREFIX+'.initial'
IDENTITY_FINAL_STATE = IDENTITY_PREFIX+'.final'
IDENTITY_SIMPLE_STATE = IDENTITY_PREFIX+'.simpleState'
IDENTITY_COMPOSITE_STATE = IDENTITY_PREFIX+'.compositeState'
