...
class NoteElement(PolygonShape, Serializable):
    ...
    def __init__(self, **kwargs):
        ...
        self.title = kwargs.get('title', _('Note'))
        self.content = kwargs.get('content', _('Content:\nInsert description here...'))
        self.titleElement = EditableLabelElement(parent=self, text=self.title)
        self.contentElement = EditableLabelElement(parent=self, text=self.content, forceMultiline=True,
