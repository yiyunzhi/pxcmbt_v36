...
MenuDef(parent=_n, label=_('InitialState'), id=EnumSTCMenuId.CREATE_INITIAL_STATE, icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='initial'),
        userData=URLObject.quick_create(STC_DIAGRAM_URL_SCHEME,
                                        STC_DIAGRAM_URL_CREATE_ELEM_NETLOC,
                                        queries={
                                            'identity': IDENTITY_INITIAL_STATE}))
MenuDef(parent=_n, label=_('SimpleState'), id=EnumSTCMenuId.CREATE_SIMPLE_STATE, icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='state'),
        userData=URLObject.quick_create(STC_DIAGRAM_URL_SCHEME,
                                        STC_DIAGRAM_URL_CREATE_ELEM_NETLOC,
                                        queries={'identity': IDENTITY_SIMPLE_STATE}))
MenuDef(parent=_n, label=_('FinalState'), id=EnumSTCMenuId.CREATE_FINAL_STATE, icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='final'),
        userData=URLObject.quick_create(STC_DIAGRAM_URL_SCHEME,
                                        STC_DIAGRAM_URL_CREATE_ELEM_NETLOC,
                                        queries={'identity': IDENTITY_FINAL_STATE}))
MenuDef(parent=_n, kind=wx.ITEM_SEPARATOR)
MenuDef(parent=_n, label=_('Note'), id=EnumSTCMenuId.CREATE_NOTE, icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='note'),
        userData=URLObject.quick_create(STC_DIAGRAM_URL_SCHEME,
                                        STC_DIAGRAM_URL_CREATE_ELEM_NETLOC,
...
MenuDef(parent=GRAPHVIEW_CTX_MENU_DEF, label=_('Zoom100%'), id=EnumSTCMenuId.ZOOM_100P, icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='zoom_100'),)
MenuDef(parent=GRAPHVIEW_CTX_MENU_DEF, kind=wx.ITEM_SEPARATOR)
...
MenuDef(parent=_n, label=_('Transition'), id=EnumSTCMenuId.CREATE_TRANSITION,icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='line1'),
        userData=URLObject.quick_create(STC_DIAGRAM_URL_SCHEME,
                                        STC_DIAGRAM_URL_CREATE_ELEM_NETLOC,
                                        queries={
                                            'identity': IDENTITY_TRANSITION}))
MenuDef(parent=_n, label=_('NoteAssociation'), id=EnumSTCMenuId.CREATE_NOTE_CONN,icon=LOCAL_XPM_IMAGE_REPO_CATEGORY.get_bmp(name='line2'),
        userData=URLObject.quick_create(STC_DIAGRAM_URL_SCHEME,
                                        STC_DIAGRAM_URL_CREATE_ELEM_NETLOC,
                                        queries={
