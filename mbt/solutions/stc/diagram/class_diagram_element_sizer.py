...
# ------------------------------------------------------------------------------
# Project       : 
# Sourcefile(s) : class_diagram_element_sizer.py
# ------------------------------------------------------------------------------
#
# File          : class_diagram_element_sizer.py
#
...
class EnumSizerOrientation:
    VERTICAL = 0
    HORIZONTAL = 1


class ElementSizerShapeStylesheet(RectShapeStylesheet):
    def __init__(self, **kwargs):
        RectShapeStylesheet.__init__(self, **kwargs)
        self.space = kwargs.get('space', 2)
        self.orientation = kwargs.get('orientation', EnumSizerOrientation.VERTICAL)
...
class ElementSizerShape(RectShape):
    __identity__ = "ElementSizerShape"

    def __init__(self, **kwargs):
        RectShape.__init__(self, **kwargs)
        self.stylesheet = kwargs.get('stylesheet', ElementSizerShapeStylesheet())
