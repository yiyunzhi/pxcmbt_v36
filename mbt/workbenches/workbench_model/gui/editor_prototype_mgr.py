...
# ------------------------------------------------------------------------------
# Project       : 
# Sourcefile(s) : editor_prototype_mgr.py
# ------------------------------------------------------------------------------
#
# File          : editor_prototype_mgr.py
#
...
class ModelPrototypeEditorView(wx.Panel, MBTUniView):
...
class ModelPrototypeSketchEditorManager(MBTViewManager):
    def __init__(self, **kwargs):
        MBTViewManager.__init__(self, **kwargs)

    def create_view(self, **kwargs)->ModelPrototypeEditorView:
        if self._view is not None:
            return self._view
        _view = ModelPrototypeEditorView(**kwargs, manager=self)
