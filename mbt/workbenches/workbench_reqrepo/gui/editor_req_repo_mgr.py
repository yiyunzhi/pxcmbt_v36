...
# ------------------------------------------------------------------------------
# Project       : 
# Sourcefile(s) : editor_req_repo_mgr.py
# ------------------------------------------------------------------------------
#
# File          : editor_req_repo_mgr.py
#
...
class TestReqRepoEditorView(wx.Panel, MBTUniView):
...
class TestReqRepoEditorManager(MBTViewManager):
    def __init__(self, **kwargs):
        MBTViewManager.__init__(self, **kwargs)

    def create_view(self, **kwargs)->TestReqRepoEditorView:
        if self._view is not None:
            return self._view
        _view = TestReqRepoEditorView(**kwargs, manager=self)
