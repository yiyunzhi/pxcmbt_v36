...
class CommandAppendProjectNode(wx.Command):
    def __init__(self, manager: MBTBaseWorkbenchViewManager, parent_node_uid: str, node_meta: dict, can_undo=True, name='AppendTestWorkbenchProjectNode'):
...
class CommandRemoveProjectNode(wx.Command):
    def __init__(self, manager: MBTBaseWorkbenchViewManager, node: ProjectTreeNode, can_undo=True, name='RemoveTestWorkbenchProjectNode'):
        wx.Command.__init__(self, can_undo, name)
        self.manager = manager
...
class CommandModifyProjectNodeProperty(wx.Command):
    def __init__(self, manager: MBTBaseWorkbenchViewManager,
                 ...
                 can_undo=True, name='RemoveTestWorkbenchProjectNode'):
        wx.Command.__init__(self, can_undo, name)
        self.manager = manager
        self.node = node
        self.nodeUid = node.uuid
...
class TestWorkbenchBaseContentContainer(MBTContentContainer):
