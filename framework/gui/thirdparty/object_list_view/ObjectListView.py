...
class ObjectListView(wx.ListCtrl):
    ...
    * useAlternateBackColors
    ...
    NAME_CHECKED_DISABLED_IMAGE="objectListView.disabledCheckImage"
    ...
    def _InitializeCheckBoxImages(self):
        ...
        _makeBitmaps(ObjectListView.NAME_CHECKED_DISABLED_IMAGE, wx.CONTROL_DISABLED)
    ...
    def _HandleTypingEvent(self, evt):
        ...
        if evt.GetUnicodeKey() == 0:
            ...
            uniChar= chr(uniChar) if isinstance(uniChar,int) else uniChar
