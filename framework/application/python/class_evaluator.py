...
class ExpressionEvaluator(ast.NodeVisitor):
    """
    class to safely parse an expression, disallowing any complicated
    ...
    def __init__(self, variables=None, functions=None, assignment=False, restrict_mode=False):
...
DEFAULT_EXPRESSION_EVALUATOR = ExpressionEvaluator(restrict_mode=False)
